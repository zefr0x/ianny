...
3. Add a new `<release>` tag under the `<releases>` tag in the [`io.github.zer0_x.ianny.metainfo.xml`](io.github.zer0_x.ianny.metainfo.xml) file with information about the release and a link to the CHANGELOG file.
